 ...
 * electron-updater library. Updates are served from the provider configured in
 * electron-builder.yml (currently GitHub Releases, using YAML manifests + artifacts).
 *
 * Platform behavior:
