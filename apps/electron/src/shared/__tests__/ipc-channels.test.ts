...
const EXPECTED_CHANNELS: string[] = [
  ...
  'projects:memoryConnectionUpdate',
  'projects:memoryConnectionsSnapshot',
  'projects:memorySearch',
  'projects:memorySpaceCreate',
  'projects:memorySpaceDelete',
  'projects:memorySpaceUpdate',
  'projects:memoryStatus',
  'projects:update',
