...
export const RPC_CHANNELS = {
  ...
  sessions: {
    ...
    CONTINUE_WITH_CONNECTION: 'sessions:continueWithConnection',
  ...
  projects: {
    ...
    MEMORY_CONNECTIONS_SNAPSHOT: 'projects:memoryConnectionsSnapshot',
    MEMORY_CONNECTION_GET: 'projects:memoryConnectionGet',
